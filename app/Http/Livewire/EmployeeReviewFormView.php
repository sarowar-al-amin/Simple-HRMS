...
class EmployeeReviewFormView extends Component
{
    ...
    public function mount() {
        $salary_review = SalaryReview::orderBy('start', 'desc')->first();
        $this->presentReview = $salary_review->id;
    ...
    public function render()
    {
        ...
        $this->sbu_promotion_recommendation;
        return view('livewire.employee-review-form-view');
    }
}
