<div>
    ...
    <table class="table-auto w-full mb-6">
        <thead>
            <tr>
                <th class="px-4 py-2">BS-23 ID</th>
                <th class="px-4 py-2">Name</th>
                <th class="px-4 py-2">SBU Name</th>
                <th class="px-4 py-2">PM Name</th>
        ...
        <tbody>
            @foreach($users as $user)
                <tr>
                    ...
                    <td class="border px-4 py-2">{{ $user->sbu }}</td>
                    <td class="border px-4 py-2">{{ $user->pm }}</td>
                    <td class="border px-4 py-2">{{ $user->promotion }}</td>
