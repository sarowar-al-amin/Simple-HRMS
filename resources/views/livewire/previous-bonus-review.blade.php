<div>
    ...
    <form id="reviewForm" action={{ route('previous-bonus-review-calculation.store', ['user' => $employee]) }} method="POST" encType="multipart/form-data">
        ...
        <h1>Previous Performance Rating</h1>
        ...
        <div class="d-flex justify-content-between p-4">
            <x-adminlte-button class="btn btn-lg" onclick="history.back()" label="Back" theme="danger" />
