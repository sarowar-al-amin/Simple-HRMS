          ...
          <div class="row gutters-sm">
            <div class="col-md-4 mb-3">
              ...
              <div class="card mt-3">
                ...
                {{-- <form action="{{url('/profile/update/{sbu}')}}" method="GET" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <hr>
                  {{-- <div class="row">Bay Area, San Francisco, CA
                    <div class="col-sm-12">
              ...
              <div class="row gutters-sm">
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Technical</i> Skills</h6>
